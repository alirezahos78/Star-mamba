...
sys.stdout = Logger(f'logs/log_efficient_vmamba_cifar100_scratch.txt')
...
# ==========================================
print("\n" + "="*60)
print("🚀 Starting Training of EfficientVMamba on CIFAR-100")
print("="*60 + "\n")

best_acc = 0.0

def save_checkpoint(model, acc, epoch, filename="efficient_vmamba_cifar100_best.pth"):
...
for epoch in range(CONFIG['epochs']):
    ...
    if test_acc > best_acc:
        ...
        best_acc = test_acc
        save_checkpoint(model, best_acc, epoch+1, f"efficient_vmamba_cifar100_best_acc{best_acc:.2f}.pth")
