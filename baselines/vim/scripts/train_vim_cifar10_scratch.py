...
sys.stdout = Logger(f'logs/log_vim_cifar10_scratch.txt')
...
# ==========================================
print("\n" + "="*60)
print("🚀 Starting Training of Vision Mamba on CIFAR-10 (Matched Conditions)")
print("="*60 + "\n")

best_acc = 0.0

def save_checkpoint(model, acc, epoch, filename="vim_cifar10_best.pth"):
...
for epoch in range(CONFIG['epochs']):
    ...
    if test_acc > best_acc:
        ...
        best_acc = test_acc
        save_checkpoint(model, best_acc, epoch+1, f"vim_cifar10_best_acc{best_acc:.2f}.pth")
